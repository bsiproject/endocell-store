...
<div class="banner-bottom">
	<div class="container">
		...
		$pilih = "SELECT * FROM tbl_pulsa a 
				  LEFT JOIN tbl_kategori b 
				  ON a.id_kategori=b.id_kategori 
				  WHERE a.id_kategori='13';";
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="row product_name">
							<h4><a href="index.php?page=detail&id=<?php echo $data['id_pulsa'];?>" value=""><?php echo $data['nama_operator']; ?></a></h4>
							<p class="pull-left"><b>Rp.<?php echo number_format($data['hargapulsa']); ?></b></p><br>
							<p value="STOK :"><b> Kategori : <?php echo $data['kategori']?></b></p>
							<p><?= $data["id_pulsa"] ?></p>
						</div>
